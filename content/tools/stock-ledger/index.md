...
draft = false
title = '台股離線股票帳本'
description = '起因：不想花錢買 App，花時間和 AI 手搓出來的台股記帳小工具。不用註冊、不用伺服器，資料存在個人裝置裡，可達到多人使用、減少服務與維護的壓力。'
...
這是一個父親節禮物，我做來給老爸的記台股小工具。

它不是投資服務，也不是什麼專業財務系統。它是一句隨口說說的需求。比較接近：我自己分散的券商要集中記錄股票時，覺得一般記帳 App 和試算表都不太順手，所以和 AI 一起把一個簡單的離線網頁慢慢磨出來。
...
這點是我很在意的。（主要是我不想負擔幫各位存資料的壓力與法律責任）

自己的記帳資料只存在你自己的瀏覽器裡，使用的是 IndexedDB。也就是說：

- 我看不到你的交易紀錄
- GitHub Pages 看不到你的帳本內容
- 沒有帳號，也沒有雲端同步
- 換手機、清除 Safari 資料、換瀏覽器之前，請先匯出 CSV（遺失得找資料修復師，找我沒有用喔）
...
- 有在買台股或 ETF，想自己留一份或是跟我一樣券商分散要統計的
- 不想為了小小的記帳需求再註冊一個服務
- 不想把持股資料放到陌生 App 或雲端
- 覺得 Excel 還行，但在手機上操作很煩的

它不適合拿來當正式報稅、公司帳務、投資建議或券商對帳替代品。這點我先說清楚～
